...
DROP TABLE IF EXISTS RestaurantPriceDiscount CASCADE;
DROP TABLE IF EXISTS RestaurantPercentageDiscount CASCADE;
DROP TABLE IF EXISTS Discounts CASCADE;
DROP TABLE IF EXISTS FDSPercentageDiscount CASCADE;
DROP TABLE IF EXISTS FDSPriceDiscount CASCADE;